...
if __name__ == '__main__':
    ...
    for i, item in enumerate(test_data):
        class1 = classifier1.classify_document(item)
        class2 = classifier2.classify_document(item)

        if class1 == true_classes[i] and class2 == true_classes[i]:
            count_correct += 1

    print(count_correct / len(test_data))

    predicted_class1 = classifier1.classify_document(sample)
    predicted_class2 = classifier2.classify_document(sample)
