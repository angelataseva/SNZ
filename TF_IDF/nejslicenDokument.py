...
if __name__ == '__main__':
    ...
    cosine_sim = rank_documents(text, documents)[0][1]
    pearson_sim = rank_documents(text, documents, pearson)[0][1]
    if cosine_sim == pearson_sim:
        flag = 'True'
    else:
        flag = 'False'

    print(f"{documents[cosine_sim]}\n{documents[pearson_sim]}\n{flag}")